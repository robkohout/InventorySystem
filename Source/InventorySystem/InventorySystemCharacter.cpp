...
void AInventorySystemCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AInventorySystemCharacter::Look);
...
void AInventorySystemCharacter::DoMove(float Right, float Forward)
{
...
void AInventorySystemCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AInventorySystemCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AInventorySystemCharacter::DoJumpEnd()
{
